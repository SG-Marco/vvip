...
MAX_STEPS = 10
LOG_INTERVER = 1
BATCH_SIZE = 4  # 한 번에 4개의 음성 파일을 처리하도록 설정

EPSILON = 0.01 # SPSA Perturbation 크기
ALPHA = 0.602 # SPSA Learning rate scaling 0.602
GAMMA = 0.101  # SPSA Decay 0.101
AK=0.8 
CK=0.05
O=10
P_TRIGGER_EPSILON = 0.00001
...
# Coordinator 초기화
# coordinator = ViTForAudio(encoder_name=ENCODER_NAME, mel_bins=NUM_MEL_BINS, frames=MAX_FRAMES, hidden_dim=COORDINATOR_HIDDEN_DIM).to(device)
